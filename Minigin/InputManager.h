...
namespace dae
{
	...
	public:
		...
		void AddCommand(Input::ControllerKey controllerKey, std::shared_ptr<Command> command);
		void AddCommand(Input::KeyCommand keyCommand, std::shared_ptr<Command> command);
